...
export declare function processPageRequest(context: BuildContext, name: string, commandOptions: any): Promise<string[]>;
...
export declare function processTabsRequest(context: BuildContext, name: string, tabs: any[], commandOptions: any): Promise<void>;
