...
export declare function createCommonModule(envVar: string, requestType: string): Promise<{}>;
...
export declare function generateTemplates(context: BuildContext, request: HydratedGeneratorRequest, includePageConstants: any): Promise<string[]>;
